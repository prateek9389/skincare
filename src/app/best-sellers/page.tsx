...
const BESTSELLER_TUBE_PRODUCTS = [
  {
    id: "daily-moisturizer",
    name: "Moisturizing Cream",
    description: "Daily skin barrier moisturizer",
    price: 36.0,
  ...
  },
  {
    ...
    name: "Moisturizing Cream",
    description: "Rose & Retinol rich ointment",
    price: 35.0,
  ...
  },
  {
    ...
    name: "Moisturizing Cream",
    description: "Hyaluronic acid wormwood serum",
    price: 20.0,
  ...
  },
  {
    ...
    name: "Moisturizing Cream",
    description: "Niacinamide balancing toner",
    price: 26.0,
      ...
      <main className="flex-grow select-none">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {BESTSELLER_TUBE_PRODUCTS.map((product, idx) => (
              <motion.div
                key={product.id}
