...
export default function InstagramBento() {
  ...
  const instagramUrl = settings.footerSocialInstagram || "https://instagram.com";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {CARDS.map((card, idx) => (
            ...
            >
              <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="block w-full h-full">
