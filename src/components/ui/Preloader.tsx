  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed inset-0 bg-[#FFFFFF] z-[9999] flex flex-col justify-between p-8 sm:p-12 lg:p-16 select-none overflow-hidden"
      >
        {/* Top Header Row */}
        <div className="flex justify-between items-center w-full z-10">
          <div>
            <span className="font-serif text-lg tracking-[0.25em] text-[#0D3C6A] uppercase font-light">
              Guna Life
            </span>
            <span className="text-[7px] tracking-[0.4em] text-[#00A896] uppercase -mt-1 block">
              Skincare
            </span>
          </div>
          <span className="text-[9px] font-bold tracking-[0.25em] text-[#00A896] uppercase">
        ...
        <div className="w-full flex-grow flex items-center justify-center relative my-8">
          <ParticleTextEffect words={["GUNALIFE", "SKINCARE"]} />
        </div>

        {/* Bottom Details Row */}
        <div className="flex justify-between items-end w-full z-10">
          <div className="space-y-1">
            <span className="text-[8px] font-bold tracking-[0.2em] text-[#00A896] uppercase block">
              System Loading
            </span>
            <span className="text-xs text-[#0D3C6A] font-light tracking-wide block max-w-[200px]">
          ...
          <div className="flex flex-col items-end">
            <span className="text-[8px] font-bold tracking-[0.2em] text-[#00A896] uppercase mb-1">
              Loading
            </span>
            <div className="flex items-baseline gap-1 text-[#0D3C6A]">
